...
$productImages    = $product['image_urls'] ?? null;
...
$description = $productName
    ? htmlspecialchars($productName . ' à ' . ($productPrice ?? 'prix inconnu') . '$ sur Uzaapp - La marketplace des téléphones et gadgets en RDC')
    : 'Ce produit n\'est plus disponible sur Uzaapp - La marketplace des téléphones et gadgets en RDC';
  ...
  <div class="container">
    ...
    <div class="product-info">
      ...
      <?php if (!empty($productPrice)): ?>
        <div class="price"><?= htmlspecialchars((string)$productPrice) ?> $</div>
      <?php endif; ?>
      <?php if ($conditionLabel): ?>
        <div class="condition"><?= htmlspecialchars($conditionLabel) ?></div>
      <?php endif; ?>
    </div>
    <a href="uzaapp://product/<?= htmlspecialchars($productId) ?>" class="btn" id="openApp" style="margin-top:20px;">Ouvrir dans l'app</a>
    <?php else: ?>
