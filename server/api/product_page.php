...
<body>
  <div class="container">
    ...
    <div class="actions">
      ...
      <?php endif; ?>
      <a href="<?= htmlspecialchars(landingWebUrl('product', $productId), ENT_QUOTES, 'UTF-8') ?>" class="btn" id="openApp">
        Accéder à Uzaapp
      </a>
    </div>
    <?php else: ?>
  ...
  <?php if ($product): renderLandingOpenScript('product', $productId); endif; ?>
</body>
</html>
